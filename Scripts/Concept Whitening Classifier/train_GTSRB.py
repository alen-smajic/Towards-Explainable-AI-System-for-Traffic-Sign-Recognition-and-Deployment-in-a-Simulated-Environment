...
def main():
    ...
    if args.arch == "resnet_cw":
        if args.depth == 50:
            model = ResidualNetTransfer(43, args, [int(x) for x in args.whitened_layers.split(',')], arch = 'resnet50', layers = [3, 4, 6, 3])#, model_file='./checkpoints/resnet50_places365.pth.tar')
        elif args.depth == 18:
            print()
            print("Model_18...........................................")
            print()
            model = ResidualNetTransfer(43, args, [int(x) for x in args.whitened_layers.split(',')], arch = 'resnet18', layers = [2, 2, 2, 2])#, model_file='C:/Users/Pasca/OneDrive/Dokumente/Master_3.Semester/Master_3.Semester/SYSL/Concept_whitening/checkpoints/blue_circle_red_triangle/ResNet18_traffic_signs_CPT_WHITEN_TRANSFER_5_model_best.pth.tar')#, model_file='./checkpoints/resnet18_places365.pth.tar')

            checkpoint = torch.load('C:/Users/Pasca/OneDrive/Dokumente/Master_3.Semester/Master_3.Semester/SYSL/Concept_whitening/checkpoints/blue_circle_red_triangle/ResNet18_traffic_signs_CPT_WHITEN_TRANSFER_5_model_best.pth.tar', map_location='cpu')
            model.load_state_dict(checkpoint['state_dict'])
            
    elif args.arch == "resnet_original" or args.arch == "resnet_baseline":
        if args.depth == 50:
            model = ResidualNetBN(43, args, arch = 'resnet50', layers = [3, 4, 6, 3])#, model_file='./checkpoints/resnet50_places365.pth.tar')
        if args.depth == 18:
            print()
            print("Model_18...........................................")
            print()
            model = ResidualNetBN(43, args, arch = 'resnet18', layers = [2, 2, 2, 2])#, model_file='C:/Users/Pasca/OneDrive/Dokumente/Master_3.Semester/Master_3.Semester/SYSL/Concept_whitening/checkpoints/blue_circle_red_triangle/ResNet18_traffic_signs_CPT_WHITEN_TRANSFER_5_model_best.pth.tar')
    elif args.arch == "densenet_cw":
        model = DenseNetTransfer(43, args, [int(x) for x in args.whitened_layers.split(',')], arch = 'densenet161')#, model_file='./checkpoints/densenet161_places365.pth.tar')
    elif args.arch == 'densenet_original':
        model = DenseNetBN(43, args, arch = 'densenet161')#, model_file='./checkpoints/densenet161_places365.pth.tar')
    ...
    testdir = args.data + 'test'
    conceptdir_train = args.data + 'concept_train'
    conceptdir_test = args.data + 'concept_test'
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder(traindir, transforms.Compose([
            transforms.Resize((224,224), Image.NEAREST), #transforms.RandomSizedCrop(224),
    ...
    for x,y in train_loader:
        ...
        #print(dataloader[1][0])
        break
    """
    
    print(conceptdir_train + "/")
    concept_loaders = [
        torch.utils.data.DataLoader(
        datasets.ImageFolder(conceptdir_train + "/" + concept, transforms.Compose([
            transforms.Resize((224,224), Image.NEAREST), #transforms.RandomSizedCrop(224),
            transforms.RandomHorizontalFlip(),
            transforms.ToTensor(),
            normalize,
    ...
    for dataloader in concept_loaders:
    ...
    val_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder(valdir, transforms.Compose([
            ...
            transforms.Resize((224,224), Image.NEAREST),#transforms.CenterCrop(224),
            transforms.ToTensor(),
            normalize,
        ])),
        batch_size=args.batch_size, shuffle=True,
    ...
    if args.evaluate == False:
        ...
        for epoch in range(args.start_epoch, args.epochs):
            print("start epoch", args.start_epoch, "end epochs", args.epochs)
        ...
        """
        saliency_map_concept_cover(args, val_loader, '1', arch='resnet_cw', dataset='GTSRB', num_concepts=4) #saliency_map_concept_cover(args, val_loader_2, '1', arch='resnet_cw', dataset='places365', num_concepts=7)
        """
    ...
    for i, (inp, target) in enumerate(train_loader):
        if (i + 1) % 20 == 0:
            ...
            if layer <= layers[0]:
                ...
                hook = model.model.layer3[layer-layers[0]-layers[1]-1].bn1.register_forward_hook(hookf)
                ...
                hook = model.model.layer4[layer-layers[0]-layers[1]-layers[2]-1].bn1.register_forward_hook(hookf)
            
            y = []
            inter_feature = []
            
            for concept_index, concept_loader in enumerate(concept_loaders):
                #print(concept_loader)
                #for j, (X, _) in enumerate(concept_loader):
...
def plot_figures(args, model, test_loader_with_path, train_loader, concept_loaders, conceptdir):
    ...
    #if not os.path.exists('C:/Users/Pasca/OneDrive/Dokumente/Master_3.Semester/Master_3.Semester/SYSL/Concept_whitening/plot' + '_'.join(concept_name)):
    #    os.mkdir('C:/Users/Pasca/OneDrive/Dokumente/Master_3.Semester/Master_3.Semester/SYSL/Concept_whitening/plot/' + '_'.join(concept_name))
...
def save_checkpoint(state, is_best, prefix, checkpoint_folder='./checkpoints'):
    ...
    if not os.path.exists(os.path.join(checkpoint_folder,concept_name)):
        ...
        print()
    #filename = os.path.join(checkpoint_folder,concept_name,'%s_model_best.pth.tar'%prefix)
    #filename = checkpoint_folder + "/" + concept_name + "/"  + '%s_checkpoint.pth.tar'%prefix
    filename = "C:/Users/Pasca/OneDrive/Dokumente/Master_3.Semester/Master_3.Semester/SYSL/Concept_whitening/checkpoints/blue_circle_red_triangle/" + "%s_checkpoint.pth.tar"%prefix
    torch.save(state, filename)
    if is_best:
         #shutil.copyfile(filename, os.path.join(checkpoint_folder,concept_name,'%s_model_best.pth.tar'%prefix))
         #shutil.copyfile(filename, checkpoint_folder + "/" concept_name + "/" + '%s_model_best.pth.tar'%prefix)
         shutil.copyfile(filename, "C:/Users/Pasca/OneDrive/Dokumente/Master_3.Semester/Master_3.Semester/SYSL/Concept_whitening/checkpoints/blue_circle_red_triangle" + "%s_model_best.pth.tar"%prefix)
